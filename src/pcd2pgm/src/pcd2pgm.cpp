...
int main(int argc, char **argv) {
  ...
  private_nh.param("file_directory", file_directory, std::string("/home/wang/ME5413_Final_Project/src/me5413_world/maps/"));

  private_nh.param("file_name", file_name, std::string("my_map_fastlio"));
