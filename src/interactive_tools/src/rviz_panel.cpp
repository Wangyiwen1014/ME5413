...
namespace rviz_panel
{
        ...
        ui_(std::make_shared<Ui::TaskControlPanel>())
    {
        ...
        // Add this line to initialize button_2_pub_
        //this->button_2_pub_ = nh_.advertise<std_msgs::String>("/button_2_clicked", 1);
    ...
    void simplePanel::on_button_2_1_clicked()
    {
        ...
        this->goal_name_msg_.data = "/area_2";
        this->pub_goal_.publish(this->goal_name_msg_);
    }
    void simplePanel::on_button_2_2_clicked()
    {
        ROS_INFO_STREAM("Button 2 clicked.");
        ui_->label_status->setText("Target detection box 2");
        system("gnome-terminal -- rosrun image_cv planning.py");
    }
